...
export class SubjectGroupsService {
  constructor(
    ...
    @InjectRepository(SubjectGroupStudentsView)
    private readonly sgStudentsRepository: Repository<SubjectGroupStudentsView>,
  ...
  getSubjectGroupStudents(subjectGroupId: number) {
